...
if __name__ == "__main__":
    ...
    # It seems that HippoCrop Series are only present 'in xx_HCropVolume' files. Current workflow code does not support for that
    # so we comment default study_dir code and replace with the one below:
    ...
    inference_agent = UNetInferenceAgent(
        device="cpu",
        parameter_file_path=r"model_2.pth")
